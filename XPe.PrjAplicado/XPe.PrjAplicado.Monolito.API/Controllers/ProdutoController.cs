...
namespace XPe.PrjAplicado.Monolito.API.Controllers
{
    ...
    public class ProdutoController : ApiControllerBase, IMigrationController<IHttpActionResult, Produto, Guid>
    {
        ...
        //Salva um produto
        [HttpPost]
        public IHttpActionResult Post(Produto entidade)
        {
        ...
        //Atualiza um produto
        [HttpPut]
        public IHttpActionResult Put(Guid codigo, Produto entidade)
        {
